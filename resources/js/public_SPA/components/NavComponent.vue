<template>
    <section id="nav" class="bg-ct-black text-ct-white select-none font-serif">
        <div class="container flex justify-between h-20">
            ...
            <svg @click="navOpen = !navOpen" class="cursor-pointer lg:hidden my-auto" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 21">
            ...
            <ul class="hidden lg:block text-2xl my-auto">
                <li v-for="navRoute in navRoutes.slice(0,-1)" :key="navRoute.path" class="inline leading-loose px-7">
